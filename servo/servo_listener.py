...
def callback(data):
    ...
    # safety check to ensure we don't exceed limits of servo
    if duty_cycle_cmd > DUTY_MAX:
        duty_cycle_cmd = DUTY_MAX
    if duty_cycle_cmd < DUTY_MIN:
        duty_cycle_cmd = DUTY_MIN
